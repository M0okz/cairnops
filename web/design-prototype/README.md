...
Identité Convergence · Titane retenue par Grégory. Le symbole et le mot-symbole vectorisés proviennent du kit final ; les 30 icônes originales utilisent un trait de 2 et des angles arrondis. Les couleurs, surfaces et bordures suivent les jetons communs de l’application, sans surcharge de palette dans la maquette. Typographie système, chiffres tabulaires et échelle de lecture agrandie par défaut : texte courant 16 px, libellés et commandes 14 px, métadonnées 12–13 px, titres 32/18 px et valeurs principales 40 px. Navigation de 264 px, barre supérieure de 64 px et commandes de 40–44 px. Le contenu utilise jusqu’à 1920 px sur grand écran. Les tailles typographiques sont exprimées en rem, sans zoom CSS. Les graduations du graphique gardent leur taille de lecture ; seuls les repères intermédiaires s’effacent lorsque la largeur manque. Contours fins et rayons de 6/8 px. Davantage d’air entre les groupes, alignements communs à l’intérieur. Les variantes de disposition et les espacements sont des propositions à reporter dans DESIGN-DIRECTION.md après choix.
