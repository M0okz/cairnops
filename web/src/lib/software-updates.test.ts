...
test('only the matching current comparison is presented as current', () => {
 const service: SoftwareService = {id:'service',target_id:'target',name:'Service',installed_version:'2.6.0',target_version:'2.10.0',observed_at:null,known:true,source:{kind:'github',url:'https://github.com/example/project',software:'Project'},suggested_source:null,confirmed_at:null,revision:4,state:'pending',last_error:'',checked_at:null,collection:null,collection_revision:null,history:[],analyses:[{notes:[],id:1,revision:3,installed_version:'2.6.0',target_version:'2.9.1',source:{kind:'github',url:'https://github.com/example/project',software:'Project'},result:{overview:[],details:[]},model:'test',created_at:'2026-09-21T00:00:00Z',current:true}]};
