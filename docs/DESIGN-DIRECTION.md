...
- En sombre, fond de page `#11100E`, volet et cartes `#1A1917`, barre supérieure `#181715`, contrôles et survols `#272624`, surfaces renforcées `#2F2E2B`. Le cartouche de l’instance reprend le fond de page pour former un retrait dans le volet. Le fond clair reste `#FAF8F4`, avec son volet blanc et le texte principal inversé entre les deux thèmes. Les surfaces et bordures déclinent ces neutres dans les jetons communs, avec la même grille et la même échelle de lecture dans les deux thèmes.
