...
- Formes solides et discrètement arrondies : 4 px pour les micro-contrôles, 6 px pour les contrôles, 8 px pour les dalles, pastilles pleinement arrondies. La Vue d’ensemble utilise des cartes à 16 px de rayon, y compris une carte indépendante par Incident ; sur grand écran, leur colonne commence au niveau de l’en-tête, à droite des indicateurs et du graphique.
