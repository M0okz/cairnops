...
- Regroupement des Preuves de plusieurs Sources dans une Atteinte de Cible, puis des Atteintes simultanées de même Nature dans un Incident unique et propagé, sans déduction de cause.
...
- Routage des notifications selon la Gravité et les Faits opérationnels, arrêté par l'Acquittement hors nouvelle aggravation ou Propagation étendue, avec notification de Résolution aux mêmes destinataires.
